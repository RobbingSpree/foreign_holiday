...
if global.market_visits == 0
	switch line
	{
		...
		case 5: load_question(global.scene,line,false); return "/3Hmm, she’s looking at me expectantly. What should I say?"; break
		...
		case 8: loc_list.loc_status[loc.alley].hidden = false; text_box.convo_end = true; global.market_visits++; return "/0Did she motion towards that /2alley/0? I guess I’ll look that way."; break
...
if global.market_visits == 1
	switch line
	{
		...
		case 4: return "/0She really won’t let me take an apple."; break;
...
if global.market_visits == 2
	switch line
	{
		case 0: return "/3 /2Apple please!?"; break;
		case 1: text_box.actor_arrive = true; text_box.talking = actor.marketman; return "/4Sote te tedoh te late te?"; break;
		case 2: return "/4La me la me laso ray so. Me sote te dohte me ray sote?"; break;
		case 3: load_question(global.scene,line,false); return "/3 /0He's looking at me expectantly..."; break;
		case 4: return "/4La te so’ tete la La so sofa ray melate!"; break;
		case 5: load_question(global.scene,line,true); return "They look upset . . ."; break;
		case 6: global.market_visits++; change_scene(loc.pstation); return "A sten looking Police Officer gets called over and takes you away.";
		case 7: text_box.convo_end = true; return "You beat a hastey retreat. Where to now?"; break;
	}
