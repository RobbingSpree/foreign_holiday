...
if global.hotel_visits == 0
	switch line
	{
		...
		case 2: return "Ok I have to find /2Charlie/0, they'll know what to do! "; break
		case 3: return "Ok to the front desk, there must be someone who can help me."; break
		case 4: return "... ... ..."; break
		...
		case 13: return "/4Sote me sola? /2Sote/0? /2Sola/0?"; break
		case 14: return "/3Ummm . . . he’s gesturing to the desk. Oooh a town map."; break
		...
		case 18: load_question(global.scene,line); return"What should I say?"; break;
		case 19: return"/4Teso La’ metelate soso te doh te te te late sola. Dohme te ray." break;
		case 20: return"/3Oh they’re inviting me to leave. I guess I’m not getting the map then." break;
		case 21: global.hotel_visits++; location_controller.tutorial_hide=false; return"I leave the hotel and head outside.";  break;

		default: return "A women approaches...";
	}
