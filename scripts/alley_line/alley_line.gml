...
if global.alley_visits == 0
	switch line
	{
		...
		case 0: return "They would never come into something this shady. Unless . . ."; break
		case 0: text_box.actor_arrive = true; text_box.talking = actor.thug; return "/4Ray so! La sote te? Te doh me me la. Sote La me so te me te. La’ sote La te ray te mete te me te late me ray te doh."; break
		case 0: load_question(global.scene,line,false); return "/3He seems to want a response..."; break
		case 0: return "/4Ray so! La so’ te soso meso laso. La sote sososote, me te sososote."; break
		case 0: return "Ummmm . . . "; break
		case 0: return ""; break
		case 0: return ""; break
		case 0: return ""; break
		case 0: return ""; break
...
Wife: She starts heading back to the cafe. “Oh dear… well, I’m sure they’ll understand. Come on, let’s go and get breakfast!” 
